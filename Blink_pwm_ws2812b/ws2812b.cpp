...
// Set the pin used to program the led's
...
// Color value using Red, Green, Blue
uint32_t ws2812b::ColorValue(byte Red, byte Green, byte Blue)
{
  uint32_t grb;
